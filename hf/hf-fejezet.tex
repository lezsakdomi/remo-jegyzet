...
A Yakindu modellező eszköz\footnote{\url{http://statecharts.org}} az Eclipse nevű fejlesztőkörnyezet egy kiterjesztéseként érhető el. Mindkét szoftver nyílt forráskódú és az \emph{Eclipse Public Licence} keretében ingyen használható. Ez a fejezet egy áttekintést ad az Eclipse és a Yakindu főbb fogalmairól.
