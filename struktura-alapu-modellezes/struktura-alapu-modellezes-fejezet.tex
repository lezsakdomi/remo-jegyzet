...
%Ez alapján megépíthetjük a problémához tartozó \fogalomragozva{tipushierarchia}{típushierarchiát}: minden \textsf{járműtelep} típusú elemre értelmezzük a helyszín és a kapacitás fogalmakat.
%Az \textsf{autóbuszgarázs} és a \textsf{kocsiszín} a \textsf{járműtelep} típusnak különböző esetei.
Mindkét típusú járműtelepnek van \textit{azonosító}, \textit{helyszín}, \textit{funkció} és \textit{kapacitás} attribútuma. Az \textsf{autóbuszgarázs} esetén a \textit{max. üzemanyag}, a \textsf{kocsiszín} esetében a \textit{vágányhossz} attribútumot rögzítjük.
...
\remofigscaleframed{jarmutelepek}{Típusgráf}{\yedscale}
...
Ismét idézzük fel \az+\refstruc{tab:jarmutelepek} járműtelepeket tartalmazó tulajdonságmodelljét.
...
\begin{pelda}
	Olyan kimutatásra van szükségünk, ami csak az egyes járműtelepek helyszínét, funkcióját és kapacitását tartalmazza.
