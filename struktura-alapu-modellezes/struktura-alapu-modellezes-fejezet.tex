...
Példa: Budapest kerületei és városrészei % https://hu.wikipedia.org/wiki/Budapest_v%C3%A1rosr%C3%A9szeinek_list%C3%A1ja

Háromszintű gyökeres fa.
...
Az \roviditesangolulkifejtve{AUTOSAR}~\cite{autosar} nagy autóipari gyártók és beszállítóik által fejlesztett szabványos architektúranyelv, amely az egyes hardver- és szoftverkomponensek együttműködése magas szinten definiálható. Az AUTOSAR konzorciumnak a Méréstechnika és Információs Rendszerek Tanszék is tagja~\cite{autosar-attendees}.
...
\begin{pelda}
	\remofigscaleframedwhite{tranzitivitas}{Az $=$ és a $<$ tulajdonságok gráfon ábrázolva}{0.7}
