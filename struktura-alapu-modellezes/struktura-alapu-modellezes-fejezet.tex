...
\fogalom{struktura-alapu-modellezes}, . A következő fejezetekben a \fogalom{viselkedes-alapu-modellezes} témakörét fogjuk körüljárni.
...
Az \rovidites{UML} egy általános célú modellezési nyelv az~\cite{UML}. Az UML három fő diagramtípust definiál:
