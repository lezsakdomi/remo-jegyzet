...
\begin{pelda}
	...
	\Az+\refstruc{fig:budapest-keruletek-varosreszek-metromegallok} modell négy szintet tartalmaz:
	...
	\begin{enumerate}
		...
		\item A legalsó szinten a metrómegállók találhatók.
	\end{enumerate}
...
\begin{itemize}
\item \roviditesteljesenkifejtve{BFS}
\item \roviditesteljesenkifejtve{DFS}
\end{itemize}
...
A \fogalom{tranzitiv-lezaras} fogalom jelentésének megértését segíti, ha ismerjük a kétváltozós relációkon értelmezett tulajdonságokat.
