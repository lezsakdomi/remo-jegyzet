...
Példa: Budapest kerületei és városrészei és a megállók % https://hu.wikipedia.org/wiki/Budapest_v%C3%A1rosr%C3%A9szeinek_list%C3%A1ja
...
\begin{pelda}
	Melyik kerületekben nincs metró? Melyik városrészben van a legtöbb metrómegálló? Ahhoz, hogy ilyen kérdésre választ kapjunk, készítsünk \fogalomragozva{hierarchikus-modell}{hierarchikus modellt}.
	
	\remofigscaleframedwhite{budapest-keruletek-varosreszek-metromegallok}{Budapest kerületei, városrészei és metrómegállói (részleges modell)}{\yedscale}
	
	\Az+\refstruc{fig:budapest-keruletek-varosreszek-metromegallok} modellje négy szintet tartalmaz:
	
	\begin{enumerate}
		\item Az első szinten egyetlen elem, \emph{Budapest} található. Ez a gráf \fogalomragozva{gyoker-csomopont}{gyökér csomópontja}.
	...
	\begin{megjegyzes}
		...
		\remofigscaleframed{budapest-explicit-tartalmazas}{\Az+\refstruc{fig:budapest-keruletek-varosreszek-metromegallok} tartalmazási hierarchiája explicit módon ábrázolva}{0.5}
	\end{megjegyzes}
\end{pelda}
...
\begin{definicio}
A \fogalom{seta} szomszédos csúcsok és élek váltakozó sorozata. Ha egy séta során egy gráfelemet sem érintünk többször, útról beszélünk, tehát az \fogalom{ut} olyan séta, amely nem metszi önmagát, valamint első és utolsó csúcsa különbözik. Körről beszélünk, ha egy út során ugyanoda érünk vissza, ahonnan elindultunk, tehát a \fogalom{kor} olyan séta, amely nem metszi önmagát, valamint első és utolsó csúcsa megegyezik. %Ezek ismeretében már beszélhetünk körmentes gráfokról.
