...
Mind a természetben előforduló, mind a mesterséges rendszerekben fellelhetők bizonyos szabályszerűségek. Az egyes szabályszerűségek a rendszer elemeinek kapcsolatait, míg mások magukat az elemeket jellemzik.
...
\begin{pelda}
	...
	\remofigscaleframedwhite{metrohev-terkep-reszlet}{Budapest metróhálózati térképe}{0.8}
\end{pelda}
...
\remofigscaleframed{budapest-explicit-tartalmazas}{\Az+\refstruc{fig:budapest-keruletek-varosreszek-metromegallok} tartalmazási hierarchiája explicit módon ábrázolva}{\yedscale}
\end{megjegyzes}
...
Ez elérhetőségvizsgálatra gyakran elemi bejáróalgoritmusokat használunk, pl. \roviditesteljesenkifejtve{BFS} és \roviditesteljesenkifejtve{DFS}.
...
\begin{pelda}
	\remofigscaleframedwhite{tranzitivitas}{Az $=$ és a $<$ tulajdonságok gráfon ábrázolva}{\yedscale}
