...
\begin{definicio}
	Egy \fogalomragozva{relacio}{relációból} \fogalomragozva{szures}{szűrt nézet} előállításához bizonyos feltétel menténk elhagyunk elemeket (sorokat) a relációból.
\end{definicio}
