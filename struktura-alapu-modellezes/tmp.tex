...
Természetesen irányítatlan gráfok ábrázolhatók irányítottként is. Kétféle elterjedt megközelítés van: 1. minden $\{v_1, v_2\}$ irányítatlan élet lecserélünk egy $(v_1, v_2)$ és egy $(v_2, v_1)$ irányított élre 2. minden irányítatlan élet egy tetszőlegs irányú irányított élre cserélünk, de a gráf feldolgozása során az irányításokat nem vesszük figyelembe.\footnote{Érdekesség: megfelelő transzformációval irányított gráfok is ábrázolhatók irányítatlan gráfként~\cite{DBLP:journals/corr/abs-0804-0277}.}
\begin{kisdefinicio}
