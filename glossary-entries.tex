...
\newglossaryentry{Dijsktra-algoritmus}{name=Dijkstra algoritmus, description=Dijksta's algorithm}
...
\newglossaryentry{szures-eltipusra}{name=szűrés éltípusra, description=filtering for edge}
...
\newglossaryentry{csucscimkezett-graf}{name=csúcscímkézett gráff, description=vertex-labeled graph}
