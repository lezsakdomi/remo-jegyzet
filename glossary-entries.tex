...
\newglossaryentry{folyamatpeldany}{name=folyamat példány, description=process instance}
...
\newglossaryentry{fork}{name=fork, description=fork}
\newglossaryentry{join}{name=join, description=join}
