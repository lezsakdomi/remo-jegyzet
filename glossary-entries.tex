...
\newacronym[description={Business Process Execution Language}]{BPEL}{BPEL}{TODO BPEL rövidítés}
...
\newglossaryentry{join-node}{name=join (találkozási/szinkornizáló) csomópont, description=join node}
