...
\newglossaryentry{allapotlefedettseg}{name=állapotlefedettség, description=state coverage}
\newglossaryentry{atmenetlefedettseg}{name=átmenetlefedettség, description=transition coverage}
