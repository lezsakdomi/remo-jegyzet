...
\newglossaryentry{fork-node}{name=fork csomópont, description=fork node}
\newglossaryentry{join-node}{name=join (találkozási) csomópont, description=join node}
\newglossaryentry{ciklus}{name=ciklus, description=loop}
\newglossaryentry{konkurrens}{name=konkurrens, description=concurrent}
\newglossaryentry{flow-begin}{name=flow begin, description=flow end}
\newglossaryentry{flow-end}{name=flow end, description=flow end}
