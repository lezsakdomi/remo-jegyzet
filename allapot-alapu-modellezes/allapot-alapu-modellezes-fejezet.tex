...
\begin{pelda}
	A kooperáló állapotgépek közötti szinkronizáció (és egyéb interakciók) illusztrációjáért lásd a Folyamatmodellezés gyakorlati feladatsor 4/\textit{e)} feladatának megoldását.
\end{pelda}
