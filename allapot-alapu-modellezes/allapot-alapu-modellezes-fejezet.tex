...
\remofigscaleframed{TrafficLight_1}{Jelzőlámpa egyszerű állapotgépe}{\allapotgeplargescale}
\end{pelda}
...
\remofigscaleframed{TrafficLight_1_sim}{Pillanatnyi állapot nyomonkövetése szimulációval}{\allapotgeplargescale}
\end{tipp}
...
\begin{pelda}
	...
	\remofigscaleframed{TrafficLight_15}{Jelzőlámpa állapotgépe \esemeny{reset} eseménnyel \halalfejes}{\allapotgeplargescale}
\end{pelda}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{TrafficLight_2_sim}{Hierarchikus állapot pillanatnyi állapotként}{\allapotgeplargescale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{TrafficLight_2}{Jelzőlámpa állapotgépe összetett állapottal}{\allapotgeplargescale}
\end{megjegyzes}
...
\remofigscaleframed{TrafficLight_3}{Jelzőlámpa állapotgépe többszintű összetett állapottal}{\allapotgeplargescale}
\end{megjegyzes}
...
\remofigscaleframed{TrafficLight_35}{Villogó jelzés külső órával \halalfejes}{\allapotgepmediumscale}
...
\remofigscaleframed{TrafficLight_4}{Villogó jelzés számlálóval}{\allapotgepmediumscale}
\end{megjegyzes}
...
\remofigscaleframed{TrafficLight_6}{Villogó jelzés időzítéssel}{\allapotgepmediumscale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{TrafficLight_7_sim}{Ortogonális állapot aktuális állapotként}{\allapotgepsmallscale}
\end{megjegyzes}
