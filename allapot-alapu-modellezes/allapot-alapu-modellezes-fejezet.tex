\topic{Állapot alapú modellezés}

\newcommand{\allapotgepscale}{0.5}
...
\begin{itemize}
%> * ![](images/tl_empty.svg) 
\item \allapot{Off}: kikapcsolt állapot
%> * ![](images/tl_red.svg) 
\item \allapot{Stop}: vörös jelzés
%> * ![](images/tl_redyellow.svg) \\
\item \allapot{Prepare}: vörös-sárga jelzés
%> * ![](images/tl_green.svg) 
\item \allapot{Go}: zöld jelzés
%> * ![](images/tl_yellow.svg) 
\item \allapot{Continue}: sárga jelzés
\end{itemize}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_1_sim}{Pillanatnyi állapot nyomonkövetése szimulációval}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_15}{Jelzőlámpa állapotgépe \esemeny{reset} eseménnyel \halalfejes}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_2}{Jelzőlámpa állapotgépe összetett állapottal}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_2_sim}{Hierarchikus állapot pillanatnyi állapotként}{\allapotgepscale}
...
%> 
%> * \{ \allapot{Off} \}
%> * \{ \allapot{On}, \allapot{Stop} \}
%> * \{ \allapot{On}, \allapot{Prepare} \}
%> * \{ \allapot{On}, \allapot{Go} \}
%> * \{ \allapot{On}, \allapot{Continue} \}
\end{megjegyzes}
...
\begin{megjegyzes}
%> **Note** A jelzőlámpa érvényes állapotterei:
%> 
%> * \{ \allapot{Off}, \allapot{On} \}
%> * \{ \allapot{Off}, \allapot{Stop}, \allapot{Prepare}, \allapot{Go}, \allapot{Continue} \}
%> 
%> Ezen felül az állapotkonfigurációk halmaza is tekinthető állapottérnek:
%> 
%> * \{ \{ \allapot{Off} \}, \{ \allapot{On}, \allapot{Stop} \}, \{ \allapot{On}, \allapot{Prepare} \}, \{ \allapot{On}, \allapot{Go} \}, \{ \allapot{On}, \allapot{Continue} \} \}
%> 
...
\begin{megjegyzes}
%> **Note** Az alábbi ábrán szemléltetett modell az \allapot{On} állapotot tovább bővíti egy \allapot{Alert} állapottal, mely a jelző sárgán villogó, figylemeztető állapotát modellezi. A rendes üzem jelzéseit a \allapot{Normal} összetett állapot tartalmazza. A \allapot{Normal} és \allapot{Alert} állapotok közötti váltás a _switchMode_ input esemény hatására történik, a $\mathit{Normal} \rightarrow \mathit{Alert}$ állapotváltás \allapot{Alert} output eseményt vált ki.
\end{megjegyzes}
 
\remofigscale{allapot-alapu-modellezes/TrafficLight_3}{Jelzőlámpa állapotgépe többszintű összetett állapottal}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_35}{Villogó jelzés külső órával \halalfejes}{\allapotgepscale}
...
A probléma megoldható \fogalomtsz{valtozo} alkalmazásával. A változó típussal rendelkezik, ez Yakinduban lehet \tipus{boolean}, \tipus{integer}, \tipus{real} vagy \tipus{string}, ezek a programozási nyelveknél megszokott logikai, egész, lebegőpontos, illetve karakterlánc típusoknak felelnek meg. Változók jelenlétében a rendszer állapotát már nemcsak a vezérlés állapota (állapot csomópontok), hanem az éppen érvényes \fogalom{valtozoertekeles} is meghatározza.
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_4}{Villogó jelzés számlálóval}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_5}{Fények állapotának modellezése változókkal}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_6}{Villogó jelzés időzítéssel}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_7_Detect}{Járműérzékelő funkció állapotgépe}{\allapotgepscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_7_sim}{Ortogonális állapot aktuális állapotként}{\allapotgepscale}
...
\begin{landscape}
\remofigscale{allapot-alapu-modellezes/TrafficLight_8}{A jelzőlámpa modellje interfészekkel}{\allapotgepscale}
\end{landscape}
...
%* Object Management Group, [Information technology -- Object Management Group Unified Modeling Language (OMG UML) -- Part 2: Superstructure]({http://www.omg.org/spec/UML/ISO/19505-2/PDF/)
	...
	\item Állapottérkép alapú forráskód generálás~\cite{samak2008practical}
	 Gergely, Pintér, [Model Based Program Synthesis and Runtime Error Detection for Dependable Embedded Systems]%(http://www.omikk.bme.hu/collections/phd/Villamosmernoki_es_Informatikai_Kar/2008/Pinter_Gergely/tezis_eng.pdf), Budapest University of Technology and Economics, Department of Measurement and Information Systems (2007)
	\item UML állapottérképek használata biztonságkritikus rendszerekben~\cite{knight1997formal, DBLP:conf/icre/NobeW96}
	* Zsigmond, Pap, [Biztonságossági kritériumok ellenőrzése UML környezetben]%(http://www.omikk.bme.hu/collections/phd/Villamosmernoki_es_Informatikai_Kar/2007/Pap_Zsigmond/tezis_hun.pdf), Budapest University of Technology and Economics, Department of Measurement and Information Systems (2006)
\end{itemize}
