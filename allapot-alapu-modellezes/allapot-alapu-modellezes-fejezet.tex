...
\newcommand{\allapotgepscale}{0.45}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_1}{Jelzőlámpa egyszerű állapotgépe}{\allapotgepscale}
\end{pelda}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_1_sim}{Pillanatnyi állapot nyomonkövetése szimulációval}{\allapotgepscale}
\end{tipp}
...
\begin{pelda}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_15}{Jelzőlámpa állapotgépe \esemeny{reset} eseménnyel \halalfejes}{\allapotgepscale}
\end{pelda}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_2_sim}{Hierarchikus állapot pillanatnyi állapotként}{\allapotgepscale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_2}{Jelzőlámpa állapotgépe összetett állapottal}{\allapotgepscale}
\end{megjegyzes}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_3}{Jelzőlámpa állapotgépe többszintű összetett állapottal}{\allapotgepscale}
\end{megjegyzes}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_4}{Villogó jelzés számlálóval}{\allapotgepscale}
\end{megjegyzes}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_6}{Villogó jelzés időzítéssel}{\allapotgepscale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_7_sim}{Ortogonális állapot aktuális állapotként}{\allapotgepscale}
\end{megjegyzes}
