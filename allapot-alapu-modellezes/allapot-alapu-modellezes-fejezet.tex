...
\remofigscale{allapot-alapu-modellezes/TrafficLight_5}{Fények állapotának modellezése változókkal}{\allapotgepmediumscale}
...
\begin{fektetett}
\remofigscale{allapot-alapu-modellezes/TrafficLight_7}{Járműérzékelős jelzőlámpa állapotgépe ortogonális állapottal}{\allapotgeplargescale}
\end{fektetett}
