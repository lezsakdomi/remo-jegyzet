...
\newcommand{\allapotgepmediumscale}{0.55}
...
\newcommand{\allapotikon}[1]{\includegraphics[height=0.3cm]{allapot-alapu-modellezes/#1}}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_1}{Jelzőlámpa egyszerű állapotgépe}{\allapotgeplargescale}
\end{pelda}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_1_sim}{Pillanatnyi állapot nyomonkövetése szimulációval}{\allapotgeplargescale}
\end{tipp}
...
\begin{pelda}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_15}{Jelzőlámpa állapotgépe \esemeny{reset} eseménnyel \halalfejes}{\allapotgeplargescale}
\end{pelda}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_2_sim}{Hierarchikus állapot pillanatnyi állapotként}{\allapotgeplargescale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_2}{Jelzőlámpa állapotgépe összetett állapottal}{\allapotgeplargescale}
\end{megjegyzes}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_3}{Jelzőlámpa állapotgépe többszintű összetett állapottal}{\allapotgeplargescale}
\end{megjegyzes}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_35}{Villogó jelzés külső órával \halalfejes}{\allapotgepmediumscale}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_4}{Villogó jelzés számlálóval}{\allapotgepmediumscale}
\end{megjegyzes}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_5}{Fények állapotának modellezése változókkal}{\allapotgeplargescale}
...
\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_6}{Villogó jelzés időzítéssel}{\allapotgepmediumscale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_7_Detect}{Járműérzékelő funkció állapotgépe}{\allapotgeplargescale}
...
\remofigscale{allapot-alapu-modellezes/TrafficLight_7}{Járműérzékelős jelzőlámpa állapotgépe ortogonális állapottal}{\allapotgepsmallscale}
...
\begin{megjegyzes}
	...
	\remofigscaleframed{allapot-alapu-modellezes/TrafficLight_7_sim}{Ortogonális állapot aktuális állapotként}{\allapotgepsmallscale}
\end{megjegyzes}
...
\begin{landscape}
	\vspace*{\fill}
	\remofigscale{allapot-alapu-modellezes/TrafficLight_8}{A jelzőlámpa modellje interfészekkel}{\allapotgeplargescale}
	\vspace*{\fill}
\end{landscape}
