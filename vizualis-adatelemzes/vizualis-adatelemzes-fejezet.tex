...
\begin{definicio}
	\begin{itemize}
		\item \Fogalom{valoszinusegi-valtozo} (\fogalomangolul{valoszinusegi-valtozo}): $X$
...
\begin{definicio}
	\begin{itemize}
		\item \Fogalom{minta} (\fogalomangolul{minta}): \fogalomragozva{megfigyeles}{megfigyelések} (\fogalomangolul{megfigyeles}) halmaza, $t$ darab, $x_1, \dots, x_t$
...
A \fogalomragozva{CLT}{centrális határeloszlás-tételből} (\roviditesangolul{CLT}) következik, hogy tetszőleges eloszlású jellemző (véges $m$ várható értékkel és $s$ szórással) tapasztalati átlaga $t \rightarrow \infty$ esetén normális eloszlású, $\mu = m$ várható értékkel és $\sigma = \frac{s}{\sqrt{t}}$ szórással.
...
\remofigscale{vizualis-adatelemzes/gaussian-distribution}{Konfidenciaintervallumok}{0.3}
