...
\begin{pelda}
\Aref{fig:szintaxis/ciklus}. ábra olyan folyamatot mutat be, ahol a fordítás után megvizsgáljuk, találtunk-e fordítási hibát; amennyiben van hiba, akkor azt megpróbáljuk kijavítani, és újrafordítjuk az állományt. Előfordul, hogy továbbra is vannak hibák, ekkor ismét a kód szerkesztése és újrafordítás következik. Ezek a tevékenységek mindaddig ismétlődnek, amíg 
\end{pelda}
...
\begin{definicio}
	\fogalom{fork-node}, \fogalom{join-node}
\end{definicio}
