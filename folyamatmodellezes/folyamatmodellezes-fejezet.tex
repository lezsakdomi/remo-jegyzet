...
\newcommand{\folyamatmodellscale}{0.6}
...
AirBnB cég AirFlow rendszere\footnote{\url{https://github.com/airbnb/airflow}}

Tudományos célú folyamatmodellező rendszerek (\emph{scientific workflow engines})

Kepler\footnote{https://kepler-project.org/}, Taverna\footnote{\url{http://incubator.apache.org/projects/taverna.html}}, ...

\subsection{Üzleti folyamatmodellek}

jBPM\footnote{\url{http://www.jbpm.org/}}, Bonita\footnote{\url{http://www.bonitasoft.com/}}, Camunda\footnote{\url{https://camunda.org/}}, Eclipse Stardust\footnote{\url{https://www.eclipse.org/stardust/}}
