...
%add the twoside option for printing & binding
...
%\newenvironment{megjegyzes}{\begin{mdframed}[backgroundcolor=white,linecolor=gray] \footnotesize \textbf{Megjegyzés.}}{\end{mdframed}}
\newenvironment{megjegyzes}{\begin{mdframed}[backgroundcolor=white,linecolor=white] \footnotesize \textbf{Megjegyzés.}}{\end{mdframed}}
...
\newenvironment{definicio}{\begin{mdframed}[backgroundcolor=white, linecolor=black] \textbf{Definíció.}}{\end{mdframed}}
...
\newenvironment{pelda}{\begin{mdframed}[backgroundcolor=white,linecolor=orange] \textbf{Példa.}}{\end{mdframed}}
